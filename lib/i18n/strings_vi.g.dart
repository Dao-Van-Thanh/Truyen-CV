...
class Translations with BaseTranslations<AppLocale, Translations> {
  ...
  late final TranslationsRootScreenVi rootScreen =
      TranslationsRootScreenVi.internal(_root);
  late final TranslationsExploreScreenVi exploreScreen =
      TranslationsExploreScreenVi.internal(_root);
  late final TranslationsStoryVi story = TranslationsStoryVi.internal(_root);
  late final TranslationsStoryDetailVi storyDetail =
      TranslationsStoryDetailVi.internal(_root);
  late final TranslationsListChapterVi listChapter =
      TranslationsListChapterVi.internal(_root);
  late final TranslationsReadStoryVi readStory =
      TranslationsReadStoryVi.internal(_root);
  late final TranslationsLibraryScreenVi libraryScreen =
      TranslationsLibraryScreenVi.internal(_root);
  late final TranslationsCommonVi common = TranslationsCommonVi.internal(_root);
  late final TranslationsIndividualVi individual =
      TranslationsIndividualVi.internal(_root);
  late final TranslationsSettingVi setting =
      TranslationsSettingVi.internal(_root);
  late final TranslationsFileImportVi fileImport =
      TranslationsFileImportVi.internal(_root);
...
class TranslationsLoginVi {
  ...
  String username(
      ...
      'Tên đăng nhập ${username} - ${name} - ${age} tuổi';
...
class TranslationsRootScreenVi {
  ...
  // Translations
  late final TranslationsRootScreenBottomNavigationBarVi bottomNavigationBar =
      TranslationsRootScreenBottomNavigationBarVi.internal(_root);
}
...
class TranslationsExploreScreenVi {
  ...
  late final TranslationsExploreScreenPagesVi pages =
      TranslationsExploreScreenPagesVi.internal(_root);
  late final TranslationsExploreScreenListTypeVi listType =
      TranslationsExploreScreenListTypeVi.internal(_root);
  late final TranslationsExploreScreenTypeVi type =
      TranslationsExploreScreenTypeVi.internal(_root);
}
...
class TranslationsReadStoryVi {
  ...
  String get resetSettingsToDefaultConfirm =>
      'Nhấn 1 lần nữa để đặt lại cài đặt';

  /// vi: 'Đã đặt lại cài đặt về mặc định'
  String get resetSettingsToDefaultSuccess => 'Đã đặt lại cài đặt về mặc định';

  late final TranslationsReadStoryTtsSettingsVi ttsSettings =
      TranslationsReadStoryTtsSettingsVi.internal(_root);
...
class TranslationsLibraryScreenVi {
  ...
  String get unfavoriteConfirmationMessage =>
      'Bạn có chắc chắn muốn bỏ yêu thích truyện này không?';

  late final TranslationsLibraryScreenOptionsBottomSheetVi optionsBottomSheet =
      TranslationsLibraryScreenOptionsBottomSheetVi.internal(_root);
}
...
class TranslationsSettingVi {
  ...
  String get deleteWarning =>
      'Toàn bộ lịch sử đọc và sách đã lưu sẽ bị xóa vĩnh viễn.';
  ...
  String get ttsTestSentence =>
      'Alo Alo, một hai ba bốn năm sáu bảy tám chín mười.';
...
class TranslationsComicVi {
  ...
  // Translations
  late final TranslationsComicTypeVi type =
      TranslationsComicTypeVi.internal(_root);
}
...
extension on Translations {
  dynamic _flatMapFunction(String path) {
    return switch (path) {
      ...
      'readStory.ttsSettings.ttsVoiceNotLoaded' =>
        'Giọng nói TTS chưa được tải',
      ...
      'libraryScreen.optionsBottomSheet.totalChapters' =>
        ({required int chapterCount}) => 'Tổng số chương: ${chapterCount}',
