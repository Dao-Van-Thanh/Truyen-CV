...
class TranslationsEn extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get buttonPressCount => 'You have pressed the button many times';
...
class _TranslationsStoryDetailEn extends TranslationsStoryDetailVi {
	...
	@override String copyStoryNameSuccess({required String name}) => 'Story name copied: ${name}';
...
class _TranslationsReadStoryEn extends TranslationsReadStoryVi {
	...
	@override String get resetSettingsToDefaultConfirm => 'Press once more to reset settings';
	...
	@override String get loadingNewChapters => 'Loading new chapters...';
	@override String get noNewChapters => 'No new chapters';
...
class _TranslationsIndividualEn extends TranslationsIndividualVi {
	...
	@override String get socialNetworkConnection => 'Social network connection';
...
class _TranslationsSettingEn extends TranslationsSettingVi {
	...
	@override String get ttsStoppedByTimer => 'Reading stopped due to timer';
	...
	@override String minutesFormat({required Object minutes}) => '${minutes} minutes';
	...
	@override String get minutes => 'minutes';
	@override String get confirm => 'Confirm';
	@override String get searchChapterHint => 'Search chapters...';
...
class _TranslationsFileImportEn extends TranslationsFileImportVi {
	_TranslationsFileImportEn._(TranslationsEn root) : this._root = root, super.internal(root);

	final TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get importing => 'Importing story...';
	@override String get addToLibrary => 'Add story to library';
	@override String get cancel => 'Cancel';
...
class _TranslationsReadStoryTtsSettingsEn extends TranslationsReadStoryTtsSettingsVi {
	...
	@override String get rate => 'Speed';
	@override String get pitch => 'Pitch';
	@override String get tryVoice => 'Try voice';
	@override String get ttsVoiceNotLoaded => 'TTS voice not loaded';
}
...
extension on TranslationsEn {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'storyDetail.copyStoryNameSuccess' => ({required String name}) => 'Story name copied: ${name}',
			...
			'readStory.resetSettingsToDefaultConfirm' => 'Press once more to reset settings',
			...
			'setting.minutesFormat' => ({required Object minutes}) => '${minutes} minutes',
